<?php
/**
 * File Name SponsorsPostType.php
 * @package WordPress
...
class SponsorsPostType {
	...
	function register_post_type() {
		...
		$this->registered = register__post_type( array(
			'post_type' => array(
				'labels' => array(
					'name' => __( 'Sponsors', 'childtheme' ),
					'singular_name' => __( 'Sponsors', 'childtheme' ),
					'add_new' => __( 'Add New', 'childtheme' ),
					'add_new_item' => __( 'Add New', 'childtheme' ),
					'edit_item' => __( 'Edit Sponsors', 'childtheme' ),
					'new_item' => __( 'New Sponsors', 'childtheme' ),
					'view_item' => __( 'View Sponsors', 'childtheme' ),
					'search_items' => __( 'Search Sponsors', 'childtheme' ),
					'not_found' => __( 'No Sponsors found', 'childtheme' ),
					'not_found_in_trash' => __( 'No Sponsors found in Trash', 'childtheme' ), 
					'parent_item_colon' => '',
					'menu_name' => __( 'Sponsors', 'childtheme' )
				),
				...
				// 'menu_position' => null,
				// 'menu_icon' => get_stylesheet_directory_uri() . "/addons/PostTypes/images/sponsors-16x16.png", // is set in class construct
				...
				// 'taxonomies' => array('post_tag', 'sponsors-tax-hierarchal'), // array of registered taxonomies
				...
				'query_var' => 'sponsors', // This goes to the WP_Query schema
				'can_export' => true,
